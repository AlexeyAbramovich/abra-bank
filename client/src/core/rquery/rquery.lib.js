...
class RQuery {
	 ...
	 * @param {string} value - The value to set to the CSS property.
	 * @returns {RQuery} The current RQuery instance for  chaining.
	 */
	css(property, value) {
	...
	attr(attributeName, value) {
		if (typeof attributeName !== 'string') {
			throw Error('Attribute name must be a string!')
		}
 ...
 * Create new RQuery instance.
 * @param {string|HTMLElement} selector - A CSS selector string or an HTMLElement
 * @returns A new RQuery instance for the given selector
 * */
